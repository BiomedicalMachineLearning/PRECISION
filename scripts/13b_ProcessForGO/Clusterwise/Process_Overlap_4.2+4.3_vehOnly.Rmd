...
comp_4.2 <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.2_bloodVScord_veh_Markers.txt")
comp_4.3 <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.3_bloodVScord_ivig_Markers.txt")
