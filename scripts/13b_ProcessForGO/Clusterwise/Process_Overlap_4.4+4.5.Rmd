...
sampleID <- "4.4v4.5"
comp_4.4 <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.4_vehVSivig_blood_Markers.txt")
comp_4.5 <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.5_vehVSivig_cord_Markers.txt")
```
