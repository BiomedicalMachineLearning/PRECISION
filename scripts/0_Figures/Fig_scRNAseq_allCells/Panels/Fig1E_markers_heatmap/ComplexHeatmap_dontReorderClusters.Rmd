...
```{r}
outdir <- "/scripts/0_Figures/Fig_scRNAseq_allCells/Panels/Fig1E_markers_heatmap/outdir/"

clusterID <- "integrated_snn_res.0.4"

seurat_markers.tab <- read.delim("/scripts/11c_Rerun_integrated_clusterMarkers/out_data/all_top10markers.txt")
