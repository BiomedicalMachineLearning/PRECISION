...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Samplewise/TraumaGenes/outdir/"

sampleID <- "traumagenes"

ck_filt_simple <- readRDS("/scripts/14_GO/Samplewise_AllGenes_RemoveRbMt/TraumaGenes/outdir/cf_traumaGenes_top100GO_FiltSimp.RDS")
```
