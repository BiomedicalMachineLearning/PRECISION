...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Samplewise/NonTraumaGenes/outdir_poolAll/"

sampleID <- "allnontraumagenes"

ck_filt_simple <- readRDS("/scripts/14_GO/Samplewise_AllGenes_RemoveRbMt/outdir_4.1_AdditionalVennOverlaps/outdir_nonTraumaGenesPooled/SCIvShamExclusive_top100GO_FiltSimp.RDS")
```
...
MakeDotplots <- function(n, width, height) {
  ...
  GOdata$direction <- factor(GOdata$direction, levels = c("up", "down"))
