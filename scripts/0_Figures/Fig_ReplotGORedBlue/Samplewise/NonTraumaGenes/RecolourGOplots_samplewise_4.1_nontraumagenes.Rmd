...
```{r}
ck_filt_simple@compareClusterResult$Cluster <- factor(ck_filt_simple@compareClusterResult$Cluster, levels = c("shamVnaive_up", "sciVnaive_up", "sciVsham_up", "shamVnaive_down", "sciVnaive_down", "sciVsham_down"))
```
