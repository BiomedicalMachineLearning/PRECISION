...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Clusterwise/sciVSsham/outdir/"

sampleID <- "4.1_sciVSsham"

ck_filt_simple <- readRDS("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/sciVSsham/outdir/cf_4.1_sciVSsham_top100GO_FiltSimp.RDS")
```
