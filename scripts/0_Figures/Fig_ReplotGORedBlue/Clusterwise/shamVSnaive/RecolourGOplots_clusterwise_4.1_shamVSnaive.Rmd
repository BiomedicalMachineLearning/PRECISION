...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Clusterwise/shamVSnaive/outdir/"

sampleID <- "4.1_shamVSnaive"

ck_filt_simple <- readRDS("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/outdir_4.1_shamVnaiveOnly/cf_4.1_shamVnaive_top100GO_FiltSimp.RDS")
```
