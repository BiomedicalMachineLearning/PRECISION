...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Clusterwise/4.1_segments/SCIvSham/outdir/"

sampleID <- "4.1_sciVSsham_exclusive"

ck_filt_simple <- readRDS("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/4.1_segment_GO/outdir_SCIvShamExclusive/cf_4.1_SCIvSham_exclusive_top100GO_FiltSimp.RDS")
```
