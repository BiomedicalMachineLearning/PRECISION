...
markers_all <- read.delim("/scripts/13b_ProcessForGO/Samplewise/outdir/4.2v4.3_ivigonly_ComparisonVenn_Markers_ivigOnly.txt")
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Samplewise/outdir/4.2v4.3_ivigonly_ComparisonVenn_Markers_RemoveRbMt_ivigOnly.txt")
GO_noRb <- read.delim("/scripts/14_GO/Samplewise_AllGenes_RemoveRbMt/outdir_4.2vs4.3_ivigOnly/genehits.txt")
