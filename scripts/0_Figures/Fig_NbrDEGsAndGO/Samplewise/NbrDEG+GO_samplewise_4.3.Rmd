...
```{r}
sampleID <- "4.3"
markers_all <- read.delim("/scripts/13b_ProcessForGO/Samplewise/outdir/4.3_bloodVScord_ivig_Markers.txt")
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Samplewise/outdir/4.3_bloodVScord_ivig_Markers_dropRbMt.txt")
GO_noRb <- read.delim("/scripts/14_GO/Samplewise_AllGenes_RemoveRbMt/outdir_4.3/clust_4.3_top100GO_FiltSimp.txt")
