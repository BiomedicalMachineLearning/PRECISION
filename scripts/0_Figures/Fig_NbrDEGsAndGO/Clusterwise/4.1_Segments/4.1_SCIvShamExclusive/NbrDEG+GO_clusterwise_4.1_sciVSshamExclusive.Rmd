...
```{r}
sampleID <- "sciVSsham"
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/4.1_splitIntoVennSegments/PutClustersTogether_outdir/SegmentsForGO_SCIvsham.txt")
...
outdir <- "/scripts/0_Figures/Fig_NbrDEGsAndGO/Clusterwise/4.1_Segments/4.1_SCIvShamExclusive/outdir/"
```
