...
```{r}
sampleID <- "sciVSnaive"
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/4.1_splitIntoVennSegments/PutClustersTogether_outdir/SegmentsForGO_SCIvnaive.txt")
  
GO_noRb <- read.delim("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/4.1_segment_GO/outdir_SCIvNaiveExclusive/cf_4.1_SCIvNaive_exclusive_top100GO_FiltSimp.txt")

outdir <- "/scripts/0_Figures/Fig_NbrDEGsAndGO/Clusterwise/4.1_Segments/4.1_SCIvNaiveExclusive/outdir/"
```
