...
```{r}
sampleID <- "4.5"
markers_all <-read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.5_vehVSivig_cord_Markers.txt")
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.5_vehVSivig_cord_Markers_dropRbMt.txt")
  
GO_noRb <- read.delim("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/outdir_4.5/clust_4.5_top100GO_FiltSimp.txt")
