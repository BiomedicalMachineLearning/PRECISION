...
```{r}
sampleID <- "sciVSsham"
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/sciVSsham/outdir/Clusterwise_SCIvsSham.txt")
  
GO_noRb <- read.delim("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/sciVSsham/outdir/cf_4.1_sciVSsham_top100GO_FiltSimp.txt")

outdir <- "/scripts/0_Figures/Fig_NbrDEGsAndGO/Clusterwise/sciVSsham/outdir/"
```
