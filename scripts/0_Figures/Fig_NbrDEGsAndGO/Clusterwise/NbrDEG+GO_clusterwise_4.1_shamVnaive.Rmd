...
markers_all <-read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.1_SCIvsshamnaive_blood_Markers_KeepSeparate.txt")
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.1_SCIvsshamnaive_blood_Markers_KeepSeparate_dropRbMt.txt")
  
GO_noRb <- read.delim("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/outdir_4.1_3ComparisonsSeparate/clust_4.1_separate_top100GO_FiltSimp.txt")
...
GO_noRb <- GO_noRb[ grep("shamVnaive", GO_noRb$Cluster),]

# add in a direction column
markers_all$direction <- markers_all$cluster
markers_all$direction <- gsub("shamVnaive_.*_", "", markers_all$direction)
...
nbr_markers_all$Var1 <- gsub("shamVnaive_", "", nbr_markers_all$Var1) #direction
...
nbr_markers_noRb$Var1 <- gsub("shamVnaive_", "", nbr_markers_noRb$Var1) #direction
...
NbrGo$Var1 <- gsub("shamVnaive_", "", NbrGo$Var1) #direction
