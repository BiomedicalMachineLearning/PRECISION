...
```{r}
seurat_markers.tab <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.1_SCIvsshamnaive_blood_Markers_KeepSeparate_dropRbMt.txt")
...
seurat_markers.tab$clusterID <- seurat_markers.tab$cluster %>% gsub("_up|_down", "", .) %>% gsub(".*_", "", .)
