...
```{r}
sampleID <- "Bcells"
df <- readRDS("/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/Bcells/out_obj/ReplotUMAP_Seurat.RDS")
outdir_metacell <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.3_RunMetacell/Bcells/out_obj/"
recolour_outdir <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.4_colouriseNetwork/Bcells/outdir/"
