...
```{r}
sampleID <- "Bcells"
df <- readRDS("/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1_ExtractClusters/out/Bcells_subset.RDS")
outdir <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/Bcells/out_data/"
outdir_obj <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/Bcells/out_obj/"
```
