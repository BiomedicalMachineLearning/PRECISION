...
---
Ellen's task: Task 7: each sample Metacell plot by itself, coloured by existing clusters, all other cells greyed out
...
```{r}
sampleID <- "vehicle"
df <- readRDS("/scripts/17_MetacellVehicleOnly/vehicle/11.1_ExtractClusters/out/vehicle_subset.RDS")
outdir_metacell <- "/scripts/17_MetacellVehicleOnly/vehicle/11.3_RunMetacell/out_obj/"
recolour_outdir <- "/scripts/17_MetacellVehicleOnly/vehicle/11.4_colouriseNetwork/SplitBySampleColourByCluster/outdir/"
...
clusterannotations <- df[[c("integrated_snn_res.0.4", "tissue", "injury", "sample")]]
# for "greyed out" columns, need to also concatenate integrated_snn_res.0.4 with timestate
clusterannotations$cell <- rownames(clusterannotations)
clusterannotations <- mutate(clusterannotations, callbysample = paste0(integrated_snn_res.0.4, "_", sample))
...
colnames(networkdata) <- c("mc2d_xval", "mc2d_yval", "integrated_snn_res.0.4", "tissue", "injury", "sample", "callbysample")
#remove metacell data absent in the seurat call list
networkdata <- networkdata[which(!is.na(networkdata$integrated_snn_res.0.4)),]
```
...
# Plot each sample separately, but colour by cluster
...
plot_B1 <- ggplot() + 
  ...
  geom_point(aes(x=networkdata_B1$mc2d_xval, y=networkdata_B1$mc2d_yval, fill=networkdata_B1$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  ...
  theme_void()
plot_B1 +  NoLegend()
ggsave(filename = paste0(recolour_outdir, sampleID, "_networkdiagram_blood_sham_veh_clusterColours.pdf"), width = 6, height = 6)

# sample B2
plot_B2 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$sample), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_B2$mc2d_xval, y=networkdata_B2$mc2d_yval, fill=networkdata_B2$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
  theme_void()
plot_B2 +  NoLegend()
ggsave(filename = paste0(recolour_outdir, sampleID, "_networkdiagram_blood_SCI_veh_clusterColours.pdf"), width = 6, height = 6)

# sample B3
plot_B3 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$sample), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_B3$mc2d_xval, y=networkdata_B3$mc2d_yval, fill=networkdata_B3$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
  theme_void()
plot_B3 +  NoLegend()
ggsave(filename = paste0(recolour_outdir, sampleID, "_networkdiagram_blood_naive_veh_clusterColours.pdf"), width = 6, height = 6)

# sample B4
plot_B4 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$sample), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_B4$mc2d_xval, y=networkdata_B4$mc2d_yval, fill=networkdata_B4$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
  theme_void()
plot_B4 +  NoLegend()
ggsave(filename = paste0(recolour_outdir, sampleID, "_networkdiagram_cord_SCI_veh_clusterColours.pdf"), width = 6, height = 6)
...
clusterannotations <- df[[c("integrated_snn_res.0.4", "tissue", "injurydrug", "sample")]]

```{r}
# Colour by cluster
DimPlot(df, cols = palette_clust, group.by = "integrated_snn_res.0.4")
ggsave(paste0(recolour_outdir, sampleID, "_cluster_dimplot.pdf"), width = 6, height = 6)
DimPlot(df, cols = palette_clust, label = TRUE, group.by = "integrated_snn_res.0.4")
...
plot_all <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, fill=networkdata$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
...
```{r}
# subset by time
networkdata_c0 <- subset(networkdata, integrated_snn_res.0.4 == "0")
networkdata_c1 <- subset(networkdata, integrated_snn_res.0.4 == "1")
networkdata_c2 <- subset(networkdata, integrated_snn_res.0.4 == "2")
networkdata_c3 <- subset(networkdata, integrated_snn_res.0.4 == "3")
networkdata_c4 <- subset(networkdata, integrated_snn_res.0.4 == "4")
networkdata_c5 <- subset(networkdata, integrated_snn_res.0.4 == "5")
networkdata_c6 <- subset(networkdata, integrated_snn_res.0.4 == "6")
networkdata_c7 <- subset(networkdata, integrated_snn_res.0.4 == "7")
networkdata_c8 <- subset(networkdata, integrated_snn_res.0.4 == "8")
networkdata_c9 <- subset(networkdata, integrated_snn_res.0.4 == "9")
networkdata_c10 <- subset(networkdata, integrated_snn_res.0.4 == "10")
#networkdata_c11 <- subset(networkdata, integrated_snn_res.0.4 == "11")
```

```{r}
# cluster 0
plot_c0 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c0$mc2d_xval, y=networkdata_c0$mc2d_yval, fill=networkdata_c0$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c1 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c1$mc2d_xval, y=networkdata_c1$mc2d_yval, fill=networkdata_c1$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c2 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c2$mc2d_xval, y=networkdata_c2$mc2d_yval, fill=networkdata_c2$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c3 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c3$mc2d_xval, y=networkdata_c3$mc2d_yval, fill=networkdata_c3$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c4 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c4$mc2d_xval, y=networkdata_c4$mc2d_yval, fill=networkdata_c4$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c5 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c5$mc2d_xval, y=networkdata_c5$mc2d_yval, fill=networkdata_c5$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c6 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c6$mc2d_xval, y=networkdata_c6$mc2d_yval, fill=networkdata_c6$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c7 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c7$mc2d_xval, y=networkdata_c7$mc2d_yval, fill=networkdata_c7$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c8 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c8$mc2d_xval, y=networkdata_c8$mc2d_yval, fill=networkdata_c8$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c9 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c9$mc2d_xval, y=networkdata_c9$mc2d_yval, fill=networkdata_c9$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
plot_c10 <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$integrated_snn_res.0.4), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_c10$mc2d_xval, y=networkdata_c10$mc2d_yval, fill=networkdata_c10$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
...
# Same thing, but colour by cell types but grey out other tissues
...
plot_cord <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$tissue), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_cord$mc2d_xval, y=networkdata_cord$mc2d_yval, fill=networkdata_cord$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
  theme_void()
plot_cord +  NoLegend()
ggsave(filename = paste0(recolour_outdir, sampleID, "_networkdiagram_cordByClust.pdf"), width = 6, height = 6)

# blood
plot_blood <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$tissue), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_blood$mc2d_xval, y=networkdata_blood$mc2d_yval, fill=networkdata_blood$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
  theme_void()
plot_blood +  NoLegend()
ggsave(filename = paste0(recolour_outdir, sampleID, "_networkdiagram_bloodByClust.pdf"), width = 6, height = 6)
```

# Same thing, but colour by cell types but grey out other tissues, and ONLY show the SCI samples

```{r}
# subset by time
networkdata_bloodSCI <- subset(networkdata_blood, injury == "SCI")
networkdata_cordSCI <- subset(networkdata_cord, injury == "SCI")
```
...
plot_cordSCI <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$tissue), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_cordSCI$mc2d_xval, y=networkdata_cordSCI$mc2d_yval, fill=networkdata_cordSCI$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
  theme_void()
plot_cord +  NoLegend()
ggsave(filename = paste0(recolour_outdir, sampleID, "_networkdiagram_SCIcordByClust.pdf"), width = 6, height = 6)

# blood
plot_blood <- ggplot() + 
  geom_point(aes(x=networkdata$mc2d_xval, y=networkdata$mc2d_yval, color=networkdata$tissue), size = 0.5, col = "grey75") +
  geom_point(aes(x=networkdata_bloodSCI$mc2d_xval, y=networkdata_bloodSCI$mc2d_yval, fill=networkdata_bloodSCI$integrated_snn_res.0.4), size = 2, shape = 21, color = "black", stroke = 0.05) +
  scale_fill_manual(values = palette_clust) +
  geom_segment(aes(x = mc2d@mc_x[fr], y = mc2d@mc_y[fr], xend = mc2d@mc_x[to], yend = mc2d@mc_y[to]), col = "gray25", size = 0.3) +
  geom_point(aes(x = mc2d@mc_x, y = mc2d@mc_y), shape = 21, fill = "white", color = "black", size = 2) +
  #geom_text(aes(x = mc2d@mc_x, y = mc2d@mc_y, label = 1:length(mc2d@mc_x)), size = 1.5) +
  theme_void()
plot_blood +  NoLegend()
ggsave(filename = paste0(recolour_outdir, sampleID, "_networkdiagram_SCIbloodByClust.pdf"), width = 6, height = 6)
```
