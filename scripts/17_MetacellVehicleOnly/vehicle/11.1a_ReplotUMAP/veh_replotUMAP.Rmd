...
outdir <- "/scripts/17_Metacell/vehicle/11.1a_ReplotUMAP/out_data/"
...
table(df[[c("clusters_wholedataset", "integrated_snn_res.0.2")]])
```
...
DefaultAssay(df) <- "RNA"
Idents(df) <- "integrated_snn_res.0.2"
...
```{r}
FeaturePlot(df, order = TRUE, features = c("C1QA", "C1QB", "C1QC"))
```
