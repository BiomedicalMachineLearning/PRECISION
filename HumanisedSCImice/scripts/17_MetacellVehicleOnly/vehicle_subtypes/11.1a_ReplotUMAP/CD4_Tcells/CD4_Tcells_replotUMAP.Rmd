...
```{r}
sampleID <- "CD4_Tcells"
df <- readRDS("/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1_ExtractClusters/out/CD4_Tcells_subset.RDS")
outdir <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/CD4_Tcells//out_data/"
outdir_obj <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/CD4_Tcells/out_obj/"
```
