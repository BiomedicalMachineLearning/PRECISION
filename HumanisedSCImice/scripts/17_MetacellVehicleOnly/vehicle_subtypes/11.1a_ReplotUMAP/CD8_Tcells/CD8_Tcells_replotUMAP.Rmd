...
```{r}
sampleID <- "CD8_Tcells"
df <- readRDS("/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1_ExtractClusters/out/CD8_Tcells_subset.RDS")
outdir <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/CD8_Tcells/out_data/"
outdir_obj <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/CD8_Tcells/out_obj/"
```
