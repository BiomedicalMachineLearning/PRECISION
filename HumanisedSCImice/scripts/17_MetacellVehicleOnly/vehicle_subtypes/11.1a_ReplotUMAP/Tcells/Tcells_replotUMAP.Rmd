...
```{r}
sampleID <- "Tcells"
df <- readRDS("/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1_ExtractClusters/out/Tcells_subset.RDS")
outdir <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/Tcells/out_data/"
outdir_obj <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/Tcells/out_obj/"
```
