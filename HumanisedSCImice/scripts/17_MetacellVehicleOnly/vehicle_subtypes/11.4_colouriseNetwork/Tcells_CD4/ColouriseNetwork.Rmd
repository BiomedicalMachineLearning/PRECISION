...
```{r}
sampleID <- "CD4Tcells"
df <- readRDS("/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.1a_ReplotUMAP/CD4_Tcells/out_obj/ReplotUMAP_Seurat.RDS")
outdir_metacell <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.3_RunMetacell/Tcells_CD4/out_obj/"
recolour_outdir <- "/scripts/17_MetacellVehicleOnly/vehicle_subtypes/11.4_colouriseNetwork/Tcells_CD4/outdir/"
