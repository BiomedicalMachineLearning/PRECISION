...
```{r}
sampleID <- "4.4"
markers_all <- read.delim("/scripts/13b_ProcessForGO/Samplewise/outdir/4.4_vehVSivig_blood_Markers.txt")
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Samplewise/outdir/4.4_vehVSivig_blood_Markers_dropRbMt.txt")
GO_noRb <- read.delim("/scripts/14_GO/Samplewise_AllGenes_RemoveRbMt/outdir_4.4/clust_4.4_top100GO_FiltSimp.txt")
