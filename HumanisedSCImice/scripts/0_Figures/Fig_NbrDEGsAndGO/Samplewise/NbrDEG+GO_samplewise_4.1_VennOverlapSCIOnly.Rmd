...
markers_all <- read.delim("/scripts/13b_ProcessForGO/Samplewise/outdir/4.1_SCIvsshamnaive_blood_ComparisonVenn_Markers_SCIonly.txt")
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Samplewise/outdir/4.1_SCIvsshamnaive_blood_ComparisonVenn_Markers_RemoveRbMt_SCIonly.txt")
GO_noRb <- read.delim("/scripts/14_GO/Samplewise_AllGenes_RemoveRbMt/outdir_4.1_VennOverlaps_SCIOnly/cf_4.1_SCI_top100GO_FiltSimp.txt")
...
```{r}
NbrGo <- as.data.frame(table(GO_noRb %>% pull(Cluster)))
