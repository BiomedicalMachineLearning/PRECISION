...
```{r}
sampleID <- "trauma"
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/TraumaGenes/outdir/Clusterwise_TraumaGenes.txt")
  
GO_noRb <- read.delim("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/TraumaGenes/outdir/cf_4.1_traumagenes_top100GO_FiltSimp.txt")

outdir <- "/scripts/0_Figures/Fig_NbrDEGsAndGO/Clusterwise/TraumaGenes/outdir/"
```
