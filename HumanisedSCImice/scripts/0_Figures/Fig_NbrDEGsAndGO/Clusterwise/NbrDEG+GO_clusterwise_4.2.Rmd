...
```{r}
sampleID <- "4.2"
markers_all <-read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.2_bloodVScord_veh_Markers.txt")
markers_noRb <- read.delim("/scripts/13b_ProcessForGO/Clusterwise/outdir/4.2_bloodVScord_veh_Markers_dropRbMt.txt")
  
GO_noRb <- read.delim("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/outdir_4.2/clust_4.2_top100GO_FiltSimp.txt")
