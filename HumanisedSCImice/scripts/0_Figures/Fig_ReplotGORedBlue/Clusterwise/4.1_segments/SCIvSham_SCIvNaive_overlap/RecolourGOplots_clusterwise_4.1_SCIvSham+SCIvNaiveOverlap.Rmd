...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Clusterwise/4.1_segments/SCIvSham_SCIvNaive_overlap/outdir/"

sampleID <- "4.1_sciVsham_sciVnaive_overlap"

ck_filt_simple <- readRDS("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/4.1_segment_GO/outdir_SCIvSham+SCIvNaiveOverlap/cf_4.1_SCIvSham+SCIvNaive_overlap_top100GO_FiltSimp.RDS")
```
