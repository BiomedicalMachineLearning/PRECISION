...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Clusterwise/4.1_segments/SCIvNaive/outdir/"

sampleID <- "4.1_sciVSnaive_exclusive"

ck_filt_simple <- readRDS("/scripts/14_GO/Clusterwise_AllGenes_RemoveRbMt/4.1_segment_GO/outdir_SCIvNaiveExclusive/cf_4.1_SCIvNaive_exclusive_top100GO_FiltSimp.RDS")
```
