...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Samplewise/sciVSsham/outdir/"

sampleID <- "sciVSsham"

ck_filt_simple <- readRDS("/scripts/14_GO/Samplewise_AllGenes_RemoveRbMt/SCIvsSham_4.1/outdir/cf_sciVsham_top100GO_FiltSimp.RDS")
```
