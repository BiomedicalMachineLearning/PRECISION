...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Samplewise/Additional4.1Analyses/Recolour_3SegmentsOfInterest/outdir/"

sampleID <- "4.1_3SegmentsOfInterest"

ck_filt_simple <- readRDS("/scripts/14_GO/Samplewise_AllGenes_RemoveRbMt/outdir_4.1_AdditionalVennOverlaps/outdir_3SegmentsOfInterest/All3Segments_top100GO_FiltSimp.RDS")
```
...
MakeDotplots <- function(n, width, height) {
  ...
  GOdata$comparison <- gsub("_.*$", "", GOdata$Cluster)
