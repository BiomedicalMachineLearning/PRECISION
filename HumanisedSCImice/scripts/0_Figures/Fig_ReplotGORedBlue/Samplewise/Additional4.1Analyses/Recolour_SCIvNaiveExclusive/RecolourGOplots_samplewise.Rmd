...
```{r}
outdir <- "/scripts/0_Figures/Fig_ReplotGORedBlue/Samplewise/Additional4.1Analyses/Recolour_SCIvNaiveExclusive/outdir/"

sampleID <- "4.1_SCIvNaiveExclusive"

ck_filt_simple <- readRDS("/scripts/14_GO/Samplewise_AllGenes_RemoveRbMt/outdir_4.1_AdditionalVennOverlaps/outdir_SCIvNaiveExclusive/SCIvNaiveExclusive_top100GO_FiltSimp.RDS")
```
