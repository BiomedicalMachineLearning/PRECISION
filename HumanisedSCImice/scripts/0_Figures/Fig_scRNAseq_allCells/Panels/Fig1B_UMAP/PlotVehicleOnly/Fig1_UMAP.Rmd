...
```{r}
df <- readRDS("/scripts/17_Metacell/vehicle/11.1a_ReplotUMAP/out_obj/ReplotUMAP_Seurat.RDS")

outdir <- "/scripts/0_Figures/Fig_scRNAseq_allCells/Panels/Fig1B_UMAP/PlotVehicleOnly/outdir/"
