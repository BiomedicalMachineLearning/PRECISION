...
```{r}
seurat_markers.tab <- read.delim("/scripts/13b_ProcessForGO/Samplewise/outdir/4.4v4.5_ComparisonVenn_Markers_RemoveRbMt.txt")
sampleID <- "4.4+4.5"
...
```{r}
keep <- rownames(df[[]])[grep("SCI", df$sample)]
