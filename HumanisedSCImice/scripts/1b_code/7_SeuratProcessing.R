...
func_runNonLinearDR <- function(seuratObj, runTSNE = "TRUE", dims = 50, neigh = 30, min.dist = 0.3) {
...
df <- func_runPCA(df, runJackstraw = "TRUE") 
df <- func_runNonLinearDR(df, runTSNE = "TRUE", dims = 50, neigh = 30, min.dist = 0.1)
