...
# Author: Laura Grice
# Date: 4th March 2020
# Title: extract_AnyCluster_subsetTime.R
# Goal: To extract a Seurat object based on one or more clusters (or other numeric annotations) from the same column, also split it up by treatment, and re-scale/re-run UMAP
